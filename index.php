 ...
 *
 * */
$appId = '1321571';  // 站点的APPID （请勿修改和泄漏）
$appKey = 'FA7304992A84B585AE207B6E0C6A6B3B';// 站点的APP KEY（请勿修改和泄漏）
...
$key = md5($requestUrl . CacheHelper::isMobile().CacheHelper::isHttps() . CacheHelper::isIPad() . CacheHelper::isIPhone() . CacheHelper::isMicroMessenger().CacheHelper::isWeibo());
